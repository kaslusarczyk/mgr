...
test_val = video_capture.set(cv2.cv.CV_CAP_PROP_POS_FRAMES, 750)

getVal = video_capture.get(cv2.cv.CV_CAP_PROP_POS_FRAMES)
print("Frame position: {0}".format(getVal))
